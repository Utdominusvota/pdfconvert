  ...
  if (!cfg) {
    return (
      <div style={{ padding: 24 }}>
        ...
        <p>The requested tool "{toolName}" has no frontend configuration yet. Add it to src/config/toolConfig.js.</p>
      </div>
    );
  }
    ...
    <div className="tool-page" style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: 280 }}>
          <label className="tp-label">Primary file</label>
        ...
        {cfg.requiresTwoFiles && (
          <div style={{ flex: 1, minWidth: 280 }}>
            <label className="tp-label">{cfg.secondaryFileLabel || 'Secondary file'}</label>
